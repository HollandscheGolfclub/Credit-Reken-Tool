...
<div class="hgc-calculator" data-calculator-mode="comparison">
    ...
    <form id="calculator-form" novalidate>
      <section class="form-step is-active" data-step="1">
        ...
        <fieldset class="field-group">
          <legend>Op welk type baan speel je meestal?</legend>
          <div class="choice-grid choice-grid--two">
            <label class="choice-card">
              ...
              <span><strong>Grote baan</strong><small>Een ronde van 9 holes</small></span>
            </label>
            <label class="choice-card">
              <input type="radio" name="round-format" value="short" />
              <span class="choice-icon choice-icon--flag">⚑</span>
              <span><strong>Kleine baan</strong><small>Shortgolf van 9 holes</small></span>
            </label>
          </div>
        </fieldset>
        ...
        <div class="field-row">
          <div class="field-group">
            <label id="course-label" for="course">Waar zou je bij Hollandsche Golfclub het vaakst spelen?</label>
            <select id="course" aria-labelledby="course-label" required></select>
      ...
      <section class="form-step" data-step="2" hidden>
        ...
        <div class="loyaltee-note">
          ...
          <p><strong>We vergelijken ook met Hollandsche Golfclub LoyalTee</strong>Inclusief 20% korting op reguliere greenfees en €25 ballentegoed. Handicapregistratie wordt standaard in ieder advies meegenomen.</p>
        </div>
