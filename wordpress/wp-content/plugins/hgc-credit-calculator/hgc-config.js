...
window.hgcConfig = {
  ...
  courses: [
    { id: "almkreek", name: "Golfpark Almkreek", location: "Almkerk", largeHoles: 9, largeRate: 0.9, shortRate: 0.6, shortGolfRate: 1, greenFee: null },
    { id: "de-berendonck", name: "Golfpark De Berendonck", location: "Wijchen", largeHoles: 9, largeRate: 1, shortRate: 0.4, shortGolfRate: 0.7, greenFee: null },
    { id: "de-breuninkhof", name: "Golfpark De Breuninkhof", location: "Voorst", largeHoles: 9, largeRate: 0.85, shortRate: 0.5, shortGolfRate: 0.75, greenFee: null },
    { id: "de-haverleij", name: "Golfpark De Haverleij", location: "’s-Hertogenbosch", largeHoles: 9, largeRate: 1, shortRate: 0.5, shortGolfRate: 0.75, greenFee: null },
    { id: "de-kurenpolder", name: "Golfpark De Kurenpolder", location: "Hank", largeHoles: 9, largeRate: 0.6, shortRate: 0.3, shortGolfRate: 0.5, greenFee: null },
    { id: "de-loonsche-duynen", name: "Golfpark De Loonsche Duynen", location: "De Moer", largeHoles: 9, largeRate: 1, shortRate: 0.6, shortGolfRate: 1, greenFee: null },
    { id: "de-purmer", name: "Golfpark De Purmer", location: "Purmerend", largeHoles: 9, largeRate: 1, shortRate: 0.4, shortGolfRate: 0.7, greenFee: null },
    { id: "gendersteyn", name: "Golfpark Gendersteyn", location: "Veldhoven", largeHoles: 9, largeRate: 1, shortRate: null, greenFee: null },
    { id: "land-van-thorn", name: "Golfpark Land van Thorn", location: "Hunsel", largeHoles: 9, largeRate: 0.75, shortRate: null, greenFee: null },
    { id: "maastricht", name: "Golfpark Maastricht International", location: "Maastricht", largeHoles: 9, largeRate: 1.4, shortRate: null, provisional: true, note: "Voorlopige creditwaarde; vervang deze zodra Hollandsche Golfclub de nieuwe credittabel publiceert.", greenFee: null },
    { id: "naarderbos", name: "Golfpark Naarderbos", location: "Naarden", largeHoles: 9, largeRate: 1, shortRate: null, provisional: true, note: "Tijdelijke rekenwaarden zolang de officiële openings- en tariefinformatie nog niet gepubliceerd is.", greenFee: null },
    { id: "reymerswael", name: "Golfpark Reymerswael", location: "Rilland-Bath", largeHoles: 12, largeRate: 1.2, shortRate: null, greenFee: null },
    { id: "rotterdam", name: "Golfpark Rotterdam", location: "Rotterdam", largeHoles: 9, largeRate: 0.7, shortRate: 0.6, shortGolfRate: 1, greenFee: null },
    ...
    { id: "sint-nyk", name: "Golfpark Sint Nyk", location: "Sint Nicolaasga", largeHoles: 9, largeRate: 0.9, shortRate: null, greenFee: null },
    { id: "westerpark", name: "Golfpark Westerpark", location: "Zoetermeer", largeHoles: 9, largeRate: 1, shortRate: null, greenFee: null },
  ],
  benefits: [
